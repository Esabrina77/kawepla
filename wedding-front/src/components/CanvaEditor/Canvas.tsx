  ...
  useEffect(() => {
    ...
    const getDefaultBackgroundColor = () => {
      ...
      if (typeof window !== "undefined") {
        ...
        return (
          computedStyle.getPropertyValue("--bg-primary").trim() || "#ffffff"
        );
      }
      return "#ffffff";
    };
    ...
    const resizeCanvas = () => {
      ...
      // Proper padding for that "Bento" floating feel
      const padding = containerWidth > 1200 ? 120 : 80;
