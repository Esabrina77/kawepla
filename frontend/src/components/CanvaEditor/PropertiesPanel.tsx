...
const PropertiesPanel = () => {
        ...
        return (
            <div className={styles.panel}>
                <div className={styles.header}>
                    <h2 className={styles.title}>Réglages de la Page</h2>
                </div>
                <div className={styles.content}>
                    <div className={styles.section}>
                        <label className={styles.label}>Arrière-plan</label>
                        ...
                        <label className={styles.subLabel}>Couleur unie</label>
                        <ColorInput
    ...
    return (
        <div className={styles.panel}>
            ...
            <div className={styles.content}>
                <div className={styles.section}>
                    <label className={styles.label}>Disposition</label>
                    <div className={styles.row}>
                        <button onClick={handleBringForward} className={styles.layerButton}>
                            <Layers size={14} /> Avancer
                        </button>
                        <button onClick={handleSendBackward} className={styles.layerButton}>
                            <Layers size={14} /> Reculer
                        </button>
                    </div>
                </div>

                <div className={styles.section}>
                    <label className={styles.label}>Opacité</label>
                    <input
                        type="range"
                        min="0"
                        max="1"
                    ...
                    <>
                        ...
                        <div className={styles.section}>
                            <div className={styles.row} style={{ marginBottom: 8, gap: 8 }}>
                                <div style={{ flex: 1 }}>
                                    <label className={styles.subLabel}>Espacement</label>
                                    <input
                                        type="number"
                                ...
                                <div style={{ flex: 1 }}>
                                    <label className={styles.subLabel}>Interligne</label>
                                    <input
                                        type="number"
                                        step="0.1"
                        ...
                        <div className={styles.section}>
                            <label className={styles.label}>Couleurs enregistrées</label>
                            <div className={styles.savedColors}>
                                {savedColors.map((color) => (
                                    <button
                                        key={color}
                ...
                {isShape && (
                    <>
                        <div className={styles.section}>
                            <label className={styles.label}>Couleur de remplissage</label>
                            <ColorInput
                                value={selectedObject.get('fill') as string}
                                onChange={(val) => updateProperty('fill', val)}
                            />
                        ...
                        <div className={styles.section}>
                            <label className={styles.label}>Bordure</label>
                            <div className={styles.row}>
                                <div style={{ width: 120 }}>
                                    <ColorInput
                        ...
                        {selectedObject.type === 'rect' && (
                            <div className={styles.section}>
                                <label className={styles.label}>Arrondi des angles</label>
                                <input
                                    type="range"
                                    min="0"
                                    max="100"
